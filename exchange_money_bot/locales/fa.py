...
STRINGS: dict[str, str] = {
    ...
    "offers.btn_edit_i": "{i}) ویرایش آگهی",
    "offers.relist_hint_html": (
        "برای <b>تغییر آگهیٔ موجود</b> دکمهٔ «<b>ویرایش آگهی</b>» را بزنید. "
        "برای <b>ثبت آگهیٔ کاملاً جدید</b> (مثلاً مبلغ یا نوع متفاوت)، از منوی اصلی "
        "«<b>ایجاد آگهی برای تبدیل ارز به ریال</b>» یا "
        "«<b>ایجاد آگهی برای تبدیل ریال به ارز</b>» را بزنید؛ "
        "هر آگهیٔ جدید در کانال جدا منتشر می‌شود."
    ),
    # Sell flow
    ...
    "edit.intro_html": (
        "<b>ویرایش آگهی</b>\n\n"
        "مقادیر فعلی: مبلغ <b>{amount:,}</b> — ارز: {currency_label}\n\n"
        "ابتدا مبلغ جدید را بفرستید (می‌توانید همان عدد قبلی را دوباره وارد کنید)."
    ),
    "edit.btn_save": "ذخیرهٔ تغییرات",
    "edit.aborted": "ویرایش لغو شد.\nیکی از گزینه‌های منو را انتخاب کنید:",
    "edit.cancelled_cmd": "ویرایش آگهی لغو شد. از منوی زیر ادامه دهید:",
    "edit.confirm_reminder": "لطفاً با دکمهٔ «انصراف» یا «ذخیرهٔ تغییرات» پاسخ دهید.",
    "edit.success_html": (
        "آگهی به‌روز شد.\n"
